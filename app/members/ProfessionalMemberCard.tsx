...
const ProfessionalMemberCard = ({
  ...
  const { name, image, linkedin, mailid, desig, desig2 } = member;
  ...
  return (
    <div className="h-full rounded-xl bg-white p-6 shadow-xl duration-500 hover:-translate-y-1 dark:bg-slate-800 lg:p-6">
      ...
      <div className="mt-6" style={{ alignContent: "end", height: "130px" }}>
        ...
        <p className="mb-4 text-sm" style={{ marginBottom : "4px"}}>
          {desig != "" ? desig : <br />}
          </p>
        ...
        <div className="mt-2">
          <div>
            ...
            <a
              ...
              target={mailtoRedirect ? "_blank" : "_self"}
            >
              <FontAwesomeIcon
                icon={faEnvelope}
                className="h-6 w-6 text-[12px]"
